...
namespace Enrollment
{
    public partial class ENROLL : Form
    {
        ...
        double nonScholar = 0;
        double fullScholar = 100;
        double partialScholar = 50;
        ...
        private void CheckToCompute()
        {
            if ((laboratoryFee_chckbx.Checked == true || registrarCard_chckbx.Checked == true ||
                ...
                partialScholarship_rbtn.Checked == true || twentypercent_rbtn.Checked == true))
            {
        ...
        private void nextPanel_btn_Click(object sender, EventArgs e)
        {
            ...
            else if (scholarGrant_Panel.Visible == true)
            {
                if (compute == true)
                {
        ...
        {
            if (totalAmount_Panel.Visible == true)
            {
        ...
        private void compute_btn_Click_1(object sender, EventArgs e)
        {
            ...
            else if (twentypercent_rbtn.Checked)
            {
                totalDiscount = twentyPercent;
            }

            double unitsEnrolled = double.Parse(unitsEnrolled_tbx.Text);
            totalUnits = unitsEnrolled * perUnits;
            totalAmount = "₱ " + Math.Round(((totalUnits * (1 - (totalDiscount / 100))) + totalFees), 2).ToString("N2");
            ...
            studentName_tbx.ReadOnly = true;
            unitsEnrolled_tbx.ReadOnly = true;
            yearLevel_cmbbx.Enabled = false;

            laboratoryFee_chckbx.Enabled = false;
            registrarCard_chckbx.Enabled = false;
            publication_chckbx.Enabled = false;
            studentCouncil_chckbx.Enabled = false;
            studentID_chckbx.Enabled = false;
            miscellaneous_chckbx.Enabled = false;

            nonScholarship_rbtn.Enabled = false;
            fullScholarship_rbtn.Enabled = false;
            partialScholarship_rbtn.Enabled = false;
            twentypercent_rbtn.Enabled = false;
        }
        ...
        private void clear_btn_Click_1(object sender, EventArgs e)
        {
            ...
            studentName_tbx.ReadOnly = false;
            unitsEnrolled_tbx.ReadOnly = false;
            yearLevel_cmbbx.Enabled = true;
            ...
            twentypercent_rbtn.Checked = false;

            laboratoryFee_chckbx.Enabled = true;
            registrarCard_chckbx.Enabled = true;
            publication_chckbx.Enabled = true;
            studentCouncil_chckbx.Enabled = true;
            studentID_chckbx.Enabled = true;
            miscellaneous_chckbx.Enabled = true;

            nonScholarship_rbtn.Enabled = true;
            fullScholarship_rbtn.Enabled = true;
            partialScholarship_rbtn.Enabled = true;
            twentypercent_rbtn.Enabled = true;
        ...
        private void twentypercent_rbtn_CheckedChanged(object sender, EventArgs e)
        {
            CheckToCompute();
        }
