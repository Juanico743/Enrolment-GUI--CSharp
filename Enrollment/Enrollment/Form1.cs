...
namespace Enrollment
{
    public partial class ENROLL : Form
    {
        ...
        private void compute_btn_Click_1(object sender, EventArgs e)
        {
            ...
            totalAmount = Math.Round((totalFees + totalUnits) - ((totalDiscount * 0.01) * (totalFees + totalUnits)), 2);
            string result = "₱ " + totalAmount.ToString("N2");
            totalAmountValue_lbl.Text = result;
